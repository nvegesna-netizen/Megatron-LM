...
class NativeDSA(nn.Module):
    def __init__(
        ...
        self.q_layernorm = nn.RMSNorm(self.q_lora_rank, eps=mla_layernorm_epsilon)
        ...
        self.kv_layernorm = nn.RMSNorm(self.kv_lora_rank, eps=mla_layernorm_epsilon)
...
def run_absorbed_mla_dsa_parity(
    *,
    ...
    try:
        ...
        assert config.mla_layernorm_epsilon is not None
        ...
        baseline = (
            NativeDSA(
                ...
                mla_layernorm_epsilon=config.mla_layernorm_epsilon,
