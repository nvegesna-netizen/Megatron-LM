...
class TransformerLayer(GraphableMegatronModule, BaseTransformerLayer):
    ...
    def __init__(
        ...
        # GraphableMegatronModule invokes create_mcore_cudagraph_manager() during super().
        # Dense layers need a default before that hook runs; MoETransformerLayer deliberately
        # sets this to True before calling this constructor.
